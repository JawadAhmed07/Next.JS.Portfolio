        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center lg:text-left lg:items-start">
            <h1 className="title-font sm:text-5xl text-3xl mb-4 font-bold text-gray-100">
              Pakistan Leading SEO
              <br className="hidden lg:inline-block" />
              Company (Since 2013)
            </h1>
            <p className="mb-8 leading-relaxed">
              Get our expert SEO services to rank on top of Google. 4X your
              sales and turn your website traffic into paying leads with Zera
              Creative.
            </p>
        ...
        <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
          <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
            ...
            <h2 className="leading-relaxed mt-4">
              Our reliable SEO experts at Zera Creative, a leading SEO company
              in Pakistan, strictly followGoogle Guidelines for 100% White Hat
              SEO. This ensures long-term success by helping you penetrate the
              global market and establish an unbeatable footprint in the major
              search engines, ultimately turning your website visitors into
              paying customers. Check out our clients’ success stories in SEO
              and see how we can help you achieve similar results!
            </h2>
            <p className="w-72 text-black px-2 italic">
              Everyone says SEO is complicated these days. At Zera Creative, we
              disagree – we see it as artful! Since day one, Google and other
              search engines’ algorithms have been trying to think like humans.
              So, why not take it a step further and prioritize optimization for
              humans first?
            </p>
            <Button className="bg-cyan-600 text-white my-5 p-6">
              Explore Seo Package
            </Button>
          </div>
          ...
          <div className="flex mx-auto align-center justify-center flex-wrap">
            <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
              ...
              <p className="leading-relaxed text-base mb-4">
                Our technical SEO experts make sure that all the search engine
                spiders crawl and index your website without any blockage to
                boost your overall SEO rankings. Moreover, we maintain a
                mobile-friendly website as Google is moving to
              </p>
            ...
            <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
              ...
              <p className="leading-relaxed text-base mb-4">
                We only use White Hat SEO practices for your website’s off page
                SEO activities like brand mentions, local seo, social media,
                guest posting and link building. We only earn genuine backlinks
                from high-authority websites to increase your domain’s
                authority.
              </p>
              <a className="text-indigo-500 inline-flex items-center">
                Learn More
            ...
            <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
              ...
              <p className="leading-relaxed text-base mb-4">
                Zera Creative is one of the top SEO services company in Pakistan
                that fulfils all your "ON page seo needs" with highly accurate
                SEO audit, competitor analysis, campaign plan, and SEO content
                audit to create fully optimized landing pages.{" "}
              </p>
              <a className="text-indigo-500 inline-flex items-center">
                Learn more
                <svg
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            ...
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">
              Dev Scripters is one of the top SEO service provider in Pakistan,
              help you grow your business. We only use reputed SEO tools, 100%
              white-hat techniques, and our own unique SEO strategies that
              provide 100% results in achieving top rankings on Google and major
              search engines. Have a look on what we offer exactly below.
            </p>
          </div>
          <div className="flex flex-wrap justify-center items-center px-10 -m-4">
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border p-4 rounded-lg">
                <div className="w-16 inline-flex items-center justify-center rounded-full mb-4">
                  <Image src={first} alt="first" width={500} height={300} />
                </div>
                <h2 className="text-2xl text-gray-900 font-bold title-font mb-2">
                  Local seo service{" "}
                </h2>
                <p className="leading-relaxed text-base">
                  To create scalable SEO campaigns, our SEO experts carry out an
                  in-depth competitive analysis. We use latest SEO tools to
                  gather data that assist us to create result-oriented plans for
                  your business.
                </p>
              </div>
            </div>
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border p-4 rounded-lg">
                <div className="w-16 inline-flex items-center justify-center rounded-full  mb-4">
                  <Image src={second} alt="" width={500} height={300} />
                </div>
                <h2 className="text-2xl text-gray-900 font-bold title-font mb-2">
                  Competitor Analysis
                </h2>
            ...
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-gray-200 p-4 rounded-lg">
                <div className="w-16 inline-flex items-center justify-center rounded-full  mb-4">
                  <Image src={third} alt="" width={500} height={300} />
                </div>
                <h2 className="text-2xl text-gray-900 font-bold title-font mb-2">
                  Keyword Research
                </h2>
                <p className="leading-relaxed text-base">
                  The SEO experts at Zera, useadvanced tools like Google
                  Keywords Planner, Ahrefs, Semrush and others to gather the
                  best long-tail and short-tail keywords with the highest
            ...
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-gray-200 p-4 rounded-lg">
                <div className="w-16 inline-flex items-center justify-center rounded-full  mb-4">
                  <Image src={fourth} alt="" width={500} height={300} />
                </div>
                <h2 className="text-2xl text-gray-900 font-bold title-font mb-2">
                  GSC/Webmaster Setup
                </h2>
                <p className="leading-relaxed text-base">
                  We help in setting up Google and Bing Webmaster setup for your
                  website. This enables you with a directory full of advanced
                  tools to gather data needed to optimize your website.
                </p>
              </div>
            </div>
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-gray-200 p-4 rounded-lg">
                <div className="w-16 inline-flex items-center justify-center rounded-full  mb-4">
                  <Image src={fifth} alt="" width={500} height={300} />
                </div>
                <h2 className="text-2xl text-gray-900 font-bold title-font mb-2">
                  Monthly SEO Report
                </h2>
                <p className="leading-relaxed text-base">
                  To ensure 100% transparency on how our SEO campaigns are
                  performing, our SEO Gurus timely monitor and provide monthly
                  analytical reports with comparison stats of the previous
                  months.
                </p>
              </div>
            </div>
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-gray-200 p-4 rounded-lg">
                <div className="w-16 inline-flex items-center justify-center rounded-full  mb-4">
                  <Image src={sixth} alt="" width={500} height={300} />
                </div>
                <h2 className="text-2xl text-gray-900 font-bold title-font mb-2">
                  SEO Optimized Content Writing
                </h2>
                <p className="leading-relaxed text-base">
                  Producing original human-written content is one imperative
                  aspect of our expert SEO services. We research and create
                  content that not only visually appeals to the readers but
            ...
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-gray-200 p-4 rounded-lg">
                <div className="w-16 inline-flex items-center justify-center rounded-full  mb-4">
                  <Image src={seventh} alt="" width={500} height={300} />
                </div>
                <h2 className="text-2xl text-gray-900 font-bold title-font mb-2">
                  Site Audits
                </h2>
                <p className="leading-relaxed text-base">
                  Our SEO experts conduct a thorough analysis of your website
                  and your competitors, and provide a detailed action plan for
                  improvements.
                </p>
              </div>
            </div>
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-gray-200 p-4 rounded-lg">
                <div className="w-16 inline-flex items-center justify-center rounded-full  mb-4">
                  <Image src={eight} alt="" width={500} height={300} />
                </div>
                <h2 className="text-2xl text-gray-900 font-bold title-font mb-2">
                  Image Optimization
                </h2>
                <p className="leading-relaxed text-base">
                  The use of image search grew to 62% among millennials. We
                  optimize all the images with alt tags, file names, titles, and
                  captions to help locate your images easily on the search
                  engines.
                </p>
              </div>
            </div>
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-gray-200 p-4 rounded-lg">
                <div className="w-16 inline-flex items-center justify-center rounded-full  mb-4">
                  <Image src={ninth} alt="" width={500} height={300} />
                </div>
                <h2 className="text-2xl text-gray-900 font-bold title-font mb-2">
                  Link Building
                </h2>
                <p className="leading-relaxed text-base">
                  Being the top SEO services company of Pakistan, we strive to
                  build the authority of your domain through a highly relevant
                  backlinking strategy. We create a full-fledged plan to get
                  genuine links from high-authority sites in your niche.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <ol className="list-decimal list-inside text-left">
              ...
              <li>
                The majority of marketers (60%) find inbound (SEO, blog content,
                etc.) to be the top source for quality leads
              </li>
              <li>SEO leads are likely to convert at a high rate of 14.6%</li>
              <li>
                First-page ranking is important as less than 1% look beyond it
              </li>
              <li>
                Top search results increase a website’s credibility and trust
              </li>
              <li>
                SEO is a cost-effective strategy for long-term traffic, unlike
                paid ads
              </li>
            </ol>

            <p className="py-2 text-xl font-bold">
              “SEO Is an Investment, Not An Added Cost”
            </p>
          </div>
        ...
        <div className="relative z-10 container mx-auto flex px-5 py-24 items-center justify-center flex-col">
          <div className="text-center lg:w-2/3 w-full">
            ...
            <p className="mb-8 w-2/3 text-xl  mx-auto text-white leading-relaxed">
              Want a first spot at Google on multiple keywords and locations?
              Fill in the contact form, and we’ll give you a call.
            </p>
