        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <p className="mb-8 leading-relaxed text-white">
              Web Design refers to the web design shown on the internet. If
              talented customers come across your website, you have a few
              seconds to fulfil your customer’s needs and keep them on your
              website. When the customers do not find out the information in a
              minute, they will likely leave your website immediately.
            </p>
          ...
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
            <Image
              ...
              alt="hero"
              src="https://thumbor.forbes.com/thumbor/fit-in/1290x/https://www.forbes.com/advisor/wp-content/uploads/2023/10/Website-Development.jpg"
            />
          </div>
        </div>
      </section>
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-500">
              Choose the perfect plan tailored to your business needs, offering
              flexibility, security, and expert support for your online
              presence.
            </p>
          ...
          <div className="flex cursor-pointer flex-wrap -m-4">
            <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div className="h-full gap-2 p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
                ...
                <li>Basic web security setup</li>
                <li>Basic SEO optimization</li>
                <li>Functional website</li>
                <li>Business logo design</li>
                <li>Hosting service included</li>
                <li>Blog (3 Articles)</li>
                <li>Free support 1 month</li>
                <li>Products up to 10 (for e-commerce)</li>
            ...
            <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div className="h-full p-6 rounded-lg border-2 border-indigo-500 gap-2 flex flex-col relative overflow-hidden">
                ...
                <li>Premium theme with advanced customization</li>
                <li>Advanced web security setup</li>
                <li>SEO optimization (standard)</li>
                <li>Dynamic Functionality</li>
                <li>Business logo design</li>
                <li>Live chat and contact forms</li>
                <li>Blog (5 Article)</li>
                <li>Hosting service included</li>
                <li>Free support 3 month</li>
                <li>Products up to 30 (for e-commerce)</li>
            ...
            <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div className="h-full p-6 rounded-lg border-2 border-gray-300 gap-2 flex flex-col relative overflow-hidden">
                ...
                <li>Up to 30 pages website</li>
                <li>Fully custom premium theme design</li>
                <li>Comprehensive web security setup</li>
                <li>Full SEO optimization and performance improvement</li>
                <li>Business logo and branding package</li>
                <li>Live chat, contact forms, CRM integration</li>
                <li>Hosting service included (premium server options)</li>
                <li>Products up to 50 (for e-commerce)</li>
            ...
            <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div className="h-full gap-2 p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
                ...
                <li>Custom theme and design from scratch</li>
                <li>Enterprise-level security</li>
                <li>Advanced SEO (includes audits, ongoing optimization)</li>
                <li>
                  Complete branding package (logo, graphics, marketing material)
                </li>
                <li>Live chat, CRM, email marketing integration</li>
                <li>Hosting service included (dedicated server)</li>
                <li>Unlimited products (for e-commerce)</li>
